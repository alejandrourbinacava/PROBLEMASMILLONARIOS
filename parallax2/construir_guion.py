...
("CAP1_DOS_CASINOS", 120, [
 ...
 ("El segundo casino es el que nadie ensena: una planta, sala de juego y poco más.",
...
("CAP4_SOCIO", 140, [
 ...
 ("Y en el otro extremo esta Maryland, donde el tipo maximo llega al sesenta y dos coma cinco.",
...
GRAFICOS = [
 ...
 ("Sesenta y dos coma cinco.", dict(tipo="anillo", valor=62.5, sufijo="%",
                color=[255, 110, 86], pie="el tipo maximo de Maryland", y=0.48)),
